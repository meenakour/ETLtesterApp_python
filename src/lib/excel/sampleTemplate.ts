...
const MAPPING_ROWS: (string | number)[][] = [
  ['customers', 'raw', 'customer_id', 'customers', 'curated', 'customer_id', 'INT', '', 'Y', 'N'],
  [
    'customers',
    'raw',
    'first_name',
  ...
  ['customers', 'raw', 'email', 'customers', 'curated', 'email', 'VARCHAR(100)', '', 'N', 'Y'],
  [
    'customers',
    'raw',
    'signup_date',
  ...
  ['orders', 'raw', 'order_id', 'orders', 'curated', 'order_id', 'INT', '', 'Y', 'N'],
  ['orders', 'raw', 'customer_id', 'orders', 'curated', 'customer_id', 'INT', '', 'N', 'N'],
  [
    'orders',
    'raw',
    'amount',
